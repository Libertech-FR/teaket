...
import { ProjectDto } from './_dto/project.dto'
...
describe('ProjectController', () => {
  ...
  describe('search', () => {
    it('should return an array of Project objects and the total count', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 10
      const skip = 1
      const expectedResult: [Project[], number] = [[object], 1]
    ...
    it('should return an array of Project objects with default pagination', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 0
      const skip = 0
  ...
  describe('read', () => {
    it('should return the data successfully', async () => {
      const expectedResult: Project = object
  ...
  describe('create', () => {
    it('should return a Project object', async () => {
      const dto: ProjectDto = { someProp: 'value' }

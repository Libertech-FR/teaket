...
import { TriggersDto } from './_dto/triggers.dto'
...
describe('TriggersController', () => {
  ...
  describe('search', () => {
    it('should return an array of Triggers objects and the total count', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 10
      const skip = 1
      const expectedResult: [Triggers[], number] = [[object], 1]
    ...
    it('should return an array of Triggers objects with default pagination', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 0
      const skip = 0
  ...
  describe('read', () => {
    it('should return the data successfully', async () => {
      const expectedResult: Triggers = object
  ...
  describe('create', () => {
    it('should return a Triggers object', async () => {
      const dto: TriggersDto = { someProp: 'value' }

...
describe('UsersController', () => {
  ...
  describe('search', () => {
    it('should return an array of Users objects and the total count', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 10
      const skip = 1
      const expectedResult: [Users[], number] = [[object], 1]
    ...
    it('should return an array of Users objects with default pagination', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 0
      const skip = 0
  ...
  describe('read', () => {
    it('should return the data successfully', async () => {
      const expectedResult: Users = object
  ...
  describe('create', () => {
    it('should return a Users object', async () => {
      const dto: UsersDto = { someProp: 'value' }

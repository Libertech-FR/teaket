...
import { SlaDto } from './_dto/sla._dto'
...
describe('SlaController', () => {
  ...
  describe('search', () => {
    it('should return an array of Sla objects and the total count', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 10
      const skip = 1
      const expectedResult: [Sla[], number] = [[object], 1]
    ...
    it('should return an array of Sla objects with default pagination', async () => {
      const req = getMockReq()
      const query = { _id: _id.toString() }
      const limit = 0
      const skip = 0
  ...
  describe('read', () => {
    it('should return the data successfully', async () => {
      const expectedResult: Sla = object
  ...
  describe('create', () => {
    it('should return a Sla object', async () => {
      const dto: SlaDto = { someProp: 'value' }

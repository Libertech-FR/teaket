...
export class StateController extends AbstractController {
  ...
  @Post()
  public async create(@Req() req: Request, @Res() res: Response, @Body() body: StatesCreateDto) {
  ...
  @ApiParam({ name: '_id', type: String })
  public async update(@Param('_id', ObjectIdValidationPipe) _id: Types.ObjectId, @Body() body: StatesUpdateDto, @Res() res: Response) {
